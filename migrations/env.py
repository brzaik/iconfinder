...
***REMOVED*** from myapp import mymodel
***REMOVED*** target_metadata = mymodel.Base.metadata
...
def run_migrations_online():
    ...
    ***REMOVED*** this callback is used to prevent an auto-migration from being generated
    ***REMOVED*** when there are no changes to the schema
    ***REMOVED*** reference: http://alembic.zzzcomputing.com/en/latest/cookbook.html
